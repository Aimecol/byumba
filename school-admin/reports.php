...
if ($search) {
    $whereConditions[] = '(sr.title LIKE :search OR sr.report_number LIKE :search OR rt.type_name LIKE :search)';
...
try {
    ...
    $typesStmt->bindParam(':school_id', $currentUser['school_id']);
    $typesStmt->execute();
                    ...
                    <div class="text-center py-5">
                        ...
                        <p class="text-muted">
                            <?php if ($search || $status || $type): ?>
                                Try adjusting your filters or <a href="reports.php">view all reports</a>.
                            <?php else: ?>
                ...
                <?php else: ?>
                    <div class="table-responsive">
                        <table class="table table-hover data-table">
                            <thead>
                                <tr>
                                    <th data-sort="report_number">Report Number</th>
                                    <th data-sort="type_name">Type</th>
                                    <th data-sort="title">Title</th>
                                    <th data-sort="reporting_period">Period</th>
                                            ...
                                            <div>
                                                ...
                                                <?php if ($report['school_notes']): ?>
                                                    <small class="text-muted d-block">
                                                        ...
                                                        <?php echo htmlspecialchars(substr($report['school_notes'], 0, 50)); ?>
                                                        <?php echo strlen($report['school_notes']) > 50 ? '...' : ''; ?>
                                                    </small>
                                                <?php endif; ?>
                                            </div>
                                        </td>
                                        <td><?php echo htmlspecialchars($report['reporting_period'] ?: 'N/A'); ?></td>
                                        <td>
